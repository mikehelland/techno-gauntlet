...
public abstract class Channel2 {
    ...
    public Channel2(Context context, Jam jam, OMGSoundPool pool, String type, String sound) {
        mPool = pool;
    ...
    public boolean loadSoundSet(String json) {
        ...
        try {
            ...
            rids = new int[data.length()];
            for (int i = 0; i < data.length(); i++) {
                sound = data.getJSONObject(i);

                caption = sound.getString("caption");
